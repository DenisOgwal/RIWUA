...
public class BiocontrolAgentsDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biocontrol_agents_detail);
        ...
        try {
            ...
            Toast.makeText(BiocontrolAgentsDetail.this, EX.getMessage().toString(), Toast.LENGTH_SHORT).show();
        }
        getData();
    ...
    private void getData() {
        try {
            String URL_PROVIDERS_SINGLE = "https://riwua.org/AndroidFiles/Biocontrolsingle.php?adviseid="+adviseid;
            ...
            Toast.makeText(BiocontrolAgentsDetail.this, EX.getMessage().toString(), Toast.LENGTH_LONG).show();
        }
    }
    /**
     * Showing Dialog
