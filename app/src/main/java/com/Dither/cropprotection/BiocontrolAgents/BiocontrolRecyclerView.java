...
import java.util.List;
    ...
    public class BiocontrolRecyclerView extends RecyclerView.Adapter<com.Dither.cropprotection.BiocontrolAgents.BiocontrolRecyclerView.ViewHolder>implements Filterable {
        ...
        @Override
        public com.Dither.cropprotection.BiocontrolAgents.BiocontrolRecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(context).inflate(R.layout.content_biocontrol_agents, parent, false);
            return new com.Dither.cropprotection.BiocontrolAgents.BiocontrolRecyclerView.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(com.Dither.cropprotection.BiocontrolAgents.BiocontrolRecyclerView.ViewHolder holder, int position) {
