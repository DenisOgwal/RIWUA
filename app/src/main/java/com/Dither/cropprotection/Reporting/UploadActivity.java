...
public class UploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locs=i.getStringExtra("loc");
        subs=i.getStringExtra("subj");
        if (filePath != null) {
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            try {
                ...
                String subjects =subs;
                String locations=locs;
                String emails = db.getUserDetails().get("email").trim();
                // Adding file data to http body
                entity.addPart("image", new FileBody(sourceFile));
                // Extra parameters if you want to pass to server
                entity.addPart("email", new StringBody(emails));
                entity.addPart("subject", new StringBody(subjects));
                entity.addPart("location", new StringBody(locations));
