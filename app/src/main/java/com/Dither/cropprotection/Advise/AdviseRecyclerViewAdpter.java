...
import java.util.List;
    ...
    public class AdviseRecyclerViewAdpter extends RecyclerView.Adapter<com.Dither.cropprotection.Advise.AdviseRecyclerViewAdpter.ViewHolder> implements Filterable {
        ...
        @Override
        public com.Dither.cropprotection.Advise.AdviseRecyclerViewAdpter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(context).inflate(R.layout.content_advise, parent, false);
            return new com.Dither.cropprotection.Advise.AdviseRecyclerViewAdpter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(com.Dither.cropprotection.Advise.AdviseRecyclerViewAdpter.ViewHolder holder, int position) {
