...
public class CropDiseaseDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop_disease_detail);
        ...
        try {
            ...
            Toast.makeText(CropDiseaseDetail.this, EX.getMessage().toString(), Toast.LENGTH_SHORT).show();
        }
        getData();
    ...
    private void getData() {
        try {
            String URL_PROVIDERS_SINGLE = "https://riwua.org/AndroidFiles/DiseaseSingle.php?diseaseid="+adviseid;
                ...
                public void onResponse(JSONArray response) {
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            int me=jsonObject.getInt("Diseaseid");
                            advisesubject.setText(jsonObject.getString("Disease"));
            ...
            Toast.makeText(CropDiseaseDetail.this, EX.getMessage().toString(), Toast.LENGTH_LONG).show();
        }
    }
    /**
     * Showing Dialog
