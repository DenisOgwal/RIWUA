...
import java.util.List;
    ...
    public class CropDiseasesRecyclerViewAdapter extends RecyclerView.Adapter<com.Dither.cropprotection.CropDiseases.CropDiseasesRecyclerViewAdapter.ViewHolder> implements Filterable {
        ...
        @Override
        public com.Dither.cropprotection.CropDiseases.CropDiseasesRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(context).inflate(R.layout.content_crop_diseases, parent, false);
            return new com.Dither.cropprotection.CropDiseases.CropDiseasesRecyclerViewAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(com.Dither.cropprotection.CropDiseases.CropDiseasesRecyclerViewAdapter.ViewHolder holder, int position) {
