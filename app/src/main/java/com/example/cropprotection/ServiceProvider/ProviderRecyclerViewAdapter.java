...
import java.util.List;
    ...
    public class ProviderRecyclerViewAdapter extends RecyclerView.Adapter<com.example.cropprotection.ServiceProvider.ProviderRecyclerViewAdapter.ViewHolder> implements Filterable {
        ...
        @Override
        public com.example.cropprotection.ServiceProvider.ProviderRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(context).inflate(R.layout.content_providers, parent, false);
            return new com.example.cropprotection.ServiceProvider.ProviderRecyclerViewAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(com.example.cropprotection.ServiceProvider.ProviderRecyclerViewAdapter.ViewHolder holder, int position) {
            try{
