...
public class WaterBills extends AppCompatActivity implements WaterBillsRecyclerViewAdpter.WaterBillsAdapterListener {
    ...
    private void getData() {
        try {
            String URL_PROVIDERS_SINGLE = "https://riwua.org/AndroidFiles/Waterbills.php?meterno="+meterno;
                ...
                public void onResponse(JSONArray response) {
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            SentWaterBills.setMeterReading(jsonObject.getString("MeterNumber"));
                            SentWaterBills.setAmountPayable(jsonObject.getString("MeterNumber"));
