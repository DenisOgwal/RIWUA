...
import java.util.List;
    ...
    public class StatisticsRecyclerViewAdapter extends RecyclerView.Adapter<com.example.cropprotection.Statistics.StatisticsRecyclerViewAdapter.ViewHolder> implements Filterable {
        ...
        @Override
        public com.example.cropprotection.Statistics.StatisticsRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(context).inflate(R.layout.content_statistics, parent, false);
            return new com.example.cropprotection.Statistics.StatisticsRecyclerViewAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(com.example.cropprotection.Statistics.StatisticsRecyclerViewAdapter.ViewHolder holder, int position) {
