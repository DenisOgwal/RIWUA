package com.example.cropprotection.Statistics;
...
public class StatisticsDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(StatisticsDetail.this, EX.getMessage().toString(), Toast.LENGTH_SHORT).show();
        }
        getData();
    ...
    private void getData() {
        try {
            String URL_PROVIDERS_SINGLE = "https://riwua.org/AndroidFiles/StatisticSingle.php?statisticid="+adviseid;
                ...
                public void onResponse(JSONArray response) {
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            int me = jsonObject.getInt("Statisticid");

                            advisebytext.setText(jsonObject.getString("PostedBy"));
                            advisedate.setText(jsonObject.getString("PostDate"));
                            descriptiontext.setText(jsonObject.getString("Details"));
                            advisesubject.setText(jsonObject.getString("Statistic"));
                            downloadurl=jsonObject.getString("Attachment");
                            //Toast.makeText(StatisticsDetail.this,jsonObject.getString("PostDate"), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(StatisticsDetail.this, EX.getMessage().toString(), Toast.LENGTH_LONG).show();
        }
    }
    /**
     * Showing Dialog
